...
def get_birth_days():
    ...
    anniversary = datetime.datetime(2018, 4, 23)
...
content = (
"今天是 {_date}，{_week}，我们已经相恋<strong style='font-family: STSong; box-sizing: border-box; font-size: 14px; margin: 0;'>{_loving_days}</strong>天啦！这是我发给你的日常问候："
"</td>"
...
"<font color = '#FF9F00'><b>☔️首先是台北今日的天气：</b></font>"
"</td>"
"</tr>"
...
def get_weather_info():
    ...
    girl = requests.get(weather_api.format("台北", headers = HEADERS)).json()
...
def news():
    ...
    news = (new_post(), 
        ...
        "<font color = '#FF9F00'><b>然后，再为你送上一些大陆的新闻：",
    ...
    news = subscribe + news + ("</details>", "</td></tr><tr style='font-family: STSong; box-sizing: border-box;",
        ...
        "align='center' valign='top'><a style='font-family: STSong; box-sizing: border-box; font-size: 12px; color: #999; text-decoration: underline; margin: 0;'>你的小可爱～</a></td>",
        "</tr></table></div></div></td>",
...
mail_user = "urwwqsunshine@163.com"
mail_pass = "zssjmm126"
sender = 'urwwqsunshine@163.com'
receivers = ['ledzeppelin1201@gmail.com', '438970103@qq.com']
