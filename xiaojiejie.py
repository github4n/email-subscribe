...
content = (
"今天是 {_date}，{_week}，你已经<strong style='font-family: STSong; box-sizing: border-box; font-size: 14px; margin: 0;'>{_loving_days}</strong>天大啦！"
"</td>"
...
"<font color = '#FF9F00'><b>☔️首先我跟你讲一下今日的天气：</b></font>"
"</td>"
"</tr>"
...
def new_post():
    ...
    post = (get_weather_info(), 
        "<font color = '#FF9F00'><b>然后我要播报一下我最近网站的更新信息，",
        "最近网站更新的文章有：</b></font>", 
