...
content = (
"今天是 {_date}，{_week}，是你生命中的第<strong style='font-family: STSong; box-sizing: border-box; font-size: 14px; margin: 0;'>{_loving_days}</strong>天。"
"</td>"
...
"<font color = '#FF9F00'><b>☔️首先是广州今日的天气：</b></font>"
"</td>"
"</tr>"
...
def news():
    ...
    news = subscribe + news + ("</details>", "</td></tr><tr style='font-family: STSong; box-sizing: border-box;",
        ...
        "border-style: solid; border-width: 10px 20px;'>记得常来看看我的网站！</a></center></td></tr><tr ",
