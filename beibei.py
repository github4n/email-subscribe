...
content = (
"今天是 {_date}，{_week}，是你生命中的第<strong style='font-family: STSong; box-sizing: border-box; font-size: 14px; margin: 0;'>{_loving_days}</strong>天，这是我发给你的日常问候："
"</td>"
...
"<font color = '#FF9F00'><b>☔️首先是南京今日的天气：</b></font>"
"</td>"
"</tr>"
...
def news():
    ...
    news = (new_post(), 
        ...
        "<font color = '#FF9F00'><b>然后，再为你送上一些即时新闻：",
